...
\begin{tabular}{|c|c|c|c|c|c|}
\hline
 \multirow{2}{*}{Evaluation Index} & \multirow{2}{*}{Data Set} & \multicolumn{2}{c|}{KM} & \multicolumn{2}{c|}{SC} \\
 \cline{3-6}
    & &CADO & Weight-CADO & CADO & Weight-CADO \\
 \hline
    \multirow{5}{*}{AC} & Balloons Data Set & label-2 & label-3 & label-4 & label-5 \\
    \cline{2-6}
 ...
 \hline
     \multirow{5}{*}{NMI} & Balloons Data Set & label-2 & label-3 & label-4 & label-5 \\
    \cline{2-6}
    & Soybean-small Data Set & label-2 & label-3 & label-4 & label-5 \\
    \cline{2-6}
    & Zoo Data Set & label-2 & label-3 & label-4 & label-5 \\
    ...
    & Breast Cancer Data Set & label-2 & label-3 & label-4 & label-5 \\
 \hline
      \multirow{5}{*}{ARI} & Balloons Data Set & label-2 & label-3 & label-4 & label-5 \\
    \cline{2-6}
    & Soybean-small Data Set & label-2 & label-3 & label-4 & label-5 \\
    \cline{2-6}
    & Zoo Data Set & label-2 & label-3 & label-4 & label-5 \\
    ...
    & Breast Cancer Data Set & label-2 & label-3 & label-4 & label-5 \\
 \hline
      \multirow{5}{*}{PR} & Balloons Data Set & label-2 & label-3 & label-4 & label-5 \\
    \cline{2-6}
    & Soybean-small Data Set & label-2 & label-3 & label-4 & label-5 \\
    \cline{2-6}
    & Zoo Data Set & label-2 & label-3 & label-4 & label-5 \\
    ...
    & Breast Cancer Data Set & label-2 & label-3 & label-4 & label-5 \\
 \hline
      \multirow{5}{*}{RE} & Balloons Data Set & label-2 & label-3 & label-4 & label-5 \\
    \cline{2-6}
    & Soybean-small Data Set & label-2 & label-3 & label-4 & label-5 \\
    \cline{2-6}
    & Zoo Data Set & label-2 & label-3 & label-4 & label-5 \\
 ...
 As Table \ref{tab:Clustering Evaluation On Five Data Sets} indicates, the clustering methods with Weight-CADO, whether KM or SC, outperform those with CADO on both AC,NMI,PR,RE and ARI. The reason is that the effect of the weight inter-coupled interaction of categorical attributes is 
